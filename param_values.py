...
def set_default_values(args, also_hyper_params=True, single_context=False, no_boundaries=False):
    ...
    args.normalize = args.normalize if args.experiment in ('CIFAR10', 'CIFAR100','CIFAR50') else False
    args.depth = (5 if args.experiment in ('CIFAR10', 'CIFAR100','CIFAR50') else 0) if args.depth is None else args.depth
    ...
    if hasattr(args, 'recon_loss'):
        args.recon_loss = (
            "MSE" if args.experiment in ('CIFAR10', 'CIFAR100','CIFAR50') else "BCE"
    ...
    if hasattr(args, 'scenario') and args.scenario == 'task':
        ...
        args.gating_prop = (
            0.85 if (args.experiment == 'CIFAR100' or args.experiment == 'CIFAR50') else (0.9 if args.experiment == 'splitMNIST' else 0.6)
    ...
    if also_hyper_params:
        ...
        if no_boundaries:
            ...
            args.si_c = (
                10. if args.experiment == 'splitMNIST' else (100. if (args.experiment == 'CIFAR100' or args.experiment == 'CIFAR50') else 10.)
            ) if args.si_c is None else args.si_c
            args.ewc_lambda = (
                100000. if args.experiment == 'splitMNIST' else (1000. if (args.experiment == 'CIFAR100' or args.experiment == 'CIFAR50') else 100.)
            ) if args.ewc_lambda is None else args.ewc_lambda
        elif args.scenario == 'domain':
            args.si_c = (
                50000. if args.experiment == 'splitMNIST' else (500. if (args.experiment == 'CIFAR100' or args.experiment == 'CIFAR50') else 10.)
            ) if args.si_c is None else args.si_c
            args.ewc_lambda = (
                10000000000. if args.experiment == 'splitMNIST' else (1000. if (args.experiment == 'CIFAR100' or args.experiment == 'CIFAR50') else 100.)
            ) if args.ewc_lambda is None else args.ewc_lambda
        ...
        if hasattr(args, 'data_size'):
            args.data_size = (12000 if args.experiment == 'splitMNIST' else (
                60000 if args.experiment == 'permMNIST' else (5000 if (args.experiment == 'CIFAR100' or args.experiment == 'CIFAR50') else 10000)
...
def check_for_errors(args, pretrain=False, **kwargs):
    if pretrain:
        if checkattr(args, 'augment') and not args.experiment in ('CIFAR10', 'CIFAR100','CIFAR50'):
